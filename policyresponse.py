...
trends_final = pd.read_csv('./data/mobility_trends.csv')
trends_final.drop(columns=trends_final.columns[0], inplace=True) 
    ...
    html.Div([ # External 10-column
        html.Div([ # Internal row
            html.Div([ # Sunburst
                ...
                get_graph(
                    class_name='',
                    figure=get_sunburst(policy_response_df),
                    id='sunburst',
                    config=plot_config, 
                ),
            ], className = 'col-6'),
            html.Div([ #Line plot trends
                ...
                get_graph(
                    class_name='',
                    figure=get_line_plot(trends_final),
                    id='trends_plot',
                    config=plot_config, 
                ),
            ], className = 'col-6'),
